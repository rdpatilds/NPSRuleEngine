...
import com.myspace.nps.Account;

public class BCClient2 {
	...
	public static void main(String[] args) {
		...
		// Retrieve list of KIE containers
	      List<KieContainerResource> kieContainers = kieServicesClient.listContainers().getResult().getContainers();
			 ...
			 * System.out.println("No containers available..."); return; } else {
			 * 
			 * System.out.println("containers available..."); KieContainerResource container
			 * = kieContainers.get(0); String containerId = container.getContainerId();
			 * System.out.println("containerId..."+containerId); }
			 */
	      
	      int psize = kieContainers.size();
	     for(int i =0; i < psize; ++i) {
	    	 KieContainerResource container = kieContainers.get(i); 
	      ...
	      account.setContactRecordStatus("Active");
	      account.setContactEmail("Email Not Valid");
	      account.setLeaseStatus("Current");
	      account.setRecentPayment(50);
	      account.setBankruptcy("No");
	      account.setRenewal(370);
	      
	      
	      String containerId = "NPS_1.0.0-SNAPSHOT";
	      System.out.println("== Sending commands to the server ==");
	      RuleServicesClient rulesClient = kieServicesClient.getServicesClient(RuleServicesClient.class);
	      KieCommands commandsFactory = KieServices.Factory.get().getCommands();

	      Command<?> insert = commandsFactory.newInsert(account);
	      ...
	      if(executeResponse.getType() == ResponseType.SUCCESS) {
	        ...
	        System.out.println(account.isSendSurvey());
